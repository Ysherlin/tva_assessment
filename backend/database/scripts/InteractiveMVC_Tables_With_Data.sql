...
(
    ...
    status BIT NOT NULL CONSTRAINT DF_Accounts_status_status DEFAULT (0),

    CONSTRAINT PK_Accounts_status PRIMARY KEY CLUSTERED (account_code),
    CONSTRAINT FK_Accounts_status_Account FOREIGN KEY (account_code) REFERENCES Accounts(code)
);
GO
...
INSERT INTO Accounts_status (account_code, status)
SELECT code, 0
FROM Accounts;
GO